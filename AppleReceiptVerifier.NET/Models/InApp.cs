...
namespace AppleReceiptVerifier.NET.Models
{
    ...
    /// </summary>
    /// <param name="CancellationDate">The time Apple customer support canceled a transaction, or the time an auto-renewable subscription plan was upgraded. This field is only present for refunded transactions. 
    /// <a href="https://developer.apple.com/documentation/appstorereceipts/cancellation_date_ms">(docs)</a></param>
    ...
    /// <param name="ExpiresDate">The time a subscription expires or when it will renew. <a href="https://developer.apple.com/documentation/appstorereceipts/expires_date_ms">(docs)</a></param>
